    ...
    <div className={styles.container}>
        <div className={styles.grid}>
            <div className={styles.grid_card}>
                <i className='flex items-center justify-center '> <MdEmail /> </i>
                <h2>Email</h2>
            ...
            <div className={styles.grid_card}>
                        <i className='flex items-center justify-center '> <MdVoiceChat /> </i>
                        <h2>Live Chat</h2>
                    ...
                    <div className={styles.grid_card}>
                        <i className='flex items-center justify-center '> <MdForum /> </i>
